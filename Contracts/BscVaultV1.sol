...
// Bsccore Vault distributes fees equally amongst staked pools
// Have fun reading it. Hopefully it's bug-free. God bless.
contract BscVaultV1 is OwnableUpgradeSafe {
    using SafeMath for uint256;
    ...
    // Update the given pool's BSC allocation point. Can only be called by the owner.
    ...
    // ----
    // Function that adds pending rewards, called by the BSCCORE token.
    // ----
